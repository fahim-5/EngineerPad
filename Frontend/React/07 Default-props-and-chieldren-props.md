...
Default props allow you to specify default values for your component's props. If a prop isn't passed to the component, the default value will be used instead.
...
WelcomeMessage.defaultProps = {
  username: "Guest",
  message: "We're glad to see you!"
};
```

Usage examples:
- `<WelcomeMessage />` - uses both defaults
- `<WelcomeMessage username="Alice" />` - uses default message
- `<WelcomeMessage message="Hello there!" />` - uses default username
...
Usage examples:
- `<ProductCard />` - uses all defaults
- `<ProductCard name="Laptop" price={999} />` - uses default inStock value

## 2. Children Props

The children prop is a special prop that allows you to pass components or elements as children to other components. It's what appears between the opening and closing tags of a component.
...
### Example 3: Children with Function as Child (Render Props)
...
3. Remember children can be any valid React node
...
- Can be any React node or even a functio